...
def download_electricity_data():
    dataset = EUROSTAT_DATASETS["electricity_imports"]
    ...
    output_dir = Path("data/raw/eurostat/facts/electricity_imports")
    ...
    for year in range(1990, year):
        ...
        output_file = output_dir / f"electricity_imports_{year}.csv"
    ...
    print("Electricity data download completed.")
